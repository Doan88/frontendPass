    ...
    return (
        <ImageBackground style={styles.loginContainer} source={require('./assets/background.jpg')} resizeMode='cover'>
            <View style={styles.loginBox}>
                ...
                <TextInput placeholder="Username" placeholderTextColor='white' value={username} onChangeText={setUsername} style={styles.loginInput}/>
                <TextInput placeholder="Password" placeholderTextColor='white' value={password} onChangeText={setPassword} style={styles.loginInput} secureTextEntry={true}/>
...
const styles = StyleSheet.create({
    ...
    loginInput:{borderWidth:1, padding: 10, marginTop: 10, marginBottom:10, borderRadius:25, borderColor:'white', color:'white'},
