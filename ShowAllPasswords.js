...
import {View,Text,TouchableOpacity,ImageBackground,FlatList,StyleSheet,Modal} from 'react-native';
...
const styles = StyleSheet.create({
    ...
    headerForm:{flexDirection:'row', alignItems:'center', justifyContent:'center', alignSelf: 'center',shadowColor: '#000',shadowOffset: { width: 0, height: 8 },shadowOpacity: 0.8,shadowRadius: 30,elevation: 10, borderRadius: 25, paddingLeft: 10, paddingRight: 10, height: 50, marginBottom: 10},
