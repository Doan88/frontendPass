    ...
    return(
        <ImageBackground style={styles.registerContainer} source={require('./assets/background.jpg')} resizeMode='cover'>
            <View style={styles.registerBox}>
                ...
                <TextInput placeholder='Username' placeholderTextColor='white' value={username} onChangeText={setUsername} style={styles.registerInput}/>
                <TextInput placeholder='Password' placeholderTextColor='white' value={password} onChangeText={setPassword} style={styles.registerInput} secureTextEntry={true}/>
...
const styles = StyleSheet.create({
    ...
    registerInput:{borderWidth:1, padding: 10, marginTop: 10, marginBottom:10, borderRadius:25, borderColor:'white', width:'100%',color:'white'},
